...
export const PRODUCTS: Product[] = [
  ...
  // Rings Collection
  { id: 'r1', name: 'Bloodclutch Ring', price: 150, category: 'Rings', description: 'Gothic statement claw ring.', image: 'images/rings/Bloodclutch.png', popular: true },
  { id: 'r2', name: 'Ember Throne Ring', price: 150, category: 'Rings', description: 'Vintage intricate crown throne ring.', image: 'images/rings/Ember throne (1).png' },
  { id: 'r3', name: 'Heartslash Ring', price: 150, category: 'Rings', description: 'Silver slashed heart ring.', image: 'images/rings/Heartslash.png' },
  { id: 'r4', name: 'Iron Cromecrest Ring', price: 150, category: 'Rings', description: 'Chrome crest heavy signet ring.', image: 'images/rings/Iron Cromecrest.png' },
  { id: 'r5', name: 'Nightspire Ring', price: 150, category: 'Rings', description: 'Dark spire edgy ring.', image: 'images/rings/Nightspire.png' },
  { id: 'r6', name: 'Novamelt Ring', price: 150, category: 'Rings', description: 'Molten metal texture ring.', image: 'images/rings/Novamelt.png' },
  { id: 'r7', name: 'Queendrip Ring', price: 150, category: 'Rings', description: 'Dripping jewel queen ring.', image: 'images/rings/Queendrip.png' },
  { id: 'r8', name: 'Starscar Ring', price: 150, category: 'Rings', description: 'Scarred star signet ring.', image: 'images/rings/Starscar.png' },
  { id: 'r9', name: 'Venomfang Ring', price: 150, category: 'Rings', description: 'Serpent venom fang ring.', image: 'images/rings/Venomfang.png' },
  { id: 'r10', name: 'Batman Ring', price: 150, category: 'Rings', description: 'Dark knight insignia ring.', image: 'images/rings/batman.png' },
  { id: 'r11', name: 'Dear Couple Ring', price: 200, category: 'Rings', description: 'Matching couple romantic ring set.', image: 'images/rings/dear couple ring (1).png', popular: true },
  { id: 'r12', name: 'CroMicCy Relic Ring', price: 150, category: 'Rings', description: 'Intricate chrome gothic relic ring.', image: 'images/rings/CroMicCy Relic.png' },
  { id: 'r13', name: 'Cyber Serpent Ring', price: 150, category: 'Rings', description: 'Futuristic serpent wrap ring.', image: 'images/rings/Cyber Serpent.png' },
  { id: 'r14', name: 'Nocturne Star Ring', price: 150, category: 'Rings', description: 'Celestial nocturne star ring.', image: 'images/rings/Nocturne Star Ring.png' },
  { id: 'r15', name: 'XenoCrom Ring', price: 150, category: 'Rings', description: 'Alien biomechanical chrome ring.', image: 'images/rings/XenoCrom.png' },
  { id: 'r16', name: 'Cromancy Ring', price: 150, category: 'Rings', description: 'Dark magic chrome signet ring.', image: 'images/rings/cromancy.png' },
  { id: 'r17', name: 'Levidcromi Ring', price: 150, category: 'Rings', description: 'Levitating chrome texture ring.', image: 'images/rings/levidcromi.png' },
  { id: 'r18', name: 'Swirlycromacy Ring', price: 150, category: 'Rings', description: 'Swirling chrome statement ring.', image: 'images/rings/swirlycromacy.png' },
];
